...
\noindent Comparing these different options for batteries, we decided upon using \textbf{BLANK}. We evaluated 12V batteries since we ultimately decided on implementing 12V motors and these are our highest-voltage components. Comparing prices and capacity, we found that the \textbf{BLANK} was preferred because \textbf{BLANK}. \cite{ub12452024} \cite{liftmaster2024} \cite{lifepo42024}\\